...
export default function Login() {
  ...
  return (
    <>
      <Head><title>Sign In — IN &amp; OUT</title></Head>
      <div style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse at 20% 50%, rgba(0,230,118,0.06) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(68,138,255,0.06) 0%, transparent 60%)',
        }} />
        ...
        <div style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 1 }} className="animate-fade-up">
          ...
          <div style={{ textAlign: 'center', marginBottom: 36 }}>
            ...
            <p style={{ color: 'var(--text-muted)', marginTop: 8, fontSize: 15 }}>Your personal finance tracker</p>
          </div>
          ...
          <div className="glass-card" style={{ padding: 32 }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div>
                ...
                <input className="input-dark" type="password" placeholder="••••••••" required
          ...
          <p style={{ textAlign: 'center', marginTop: 16, fontSize: 12, color: 'var(--text-muted)' }}>
            Demo: demo@inandout.app / demo1234
          </p>
        </div>
      </div>
    </>
